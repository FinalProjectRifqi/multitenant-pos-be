/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c7e06c45c621a9f89edc37d6ea1e0e6e)
...
declare namespace Cloudflare {
	...
	interface Env {
		PROD_DB_PORT: "5432";
		PROD_DB_SSL: "true";
		PROD_DB_SSL_REJECT_UNAUTHORIZED: "true";
		PROD_DB_SSL_CA: "";
		PROD_DB_SSL_KEY: "";
		PROD_DB_SSL_CERT: "";
		PROD_DB_STATEMENT_TIMEOUT: "30000";
		PROD_DB_QUERY_TIMEOUT: "60000";
		...
		DEV_DB_SSL: string;
		DEV_DB_SSL_REJECT_UNAUTHORIZED: string;
		STORAGE_URL: string;
		STORAGE_SECRET_KEYS: string;
		STORAGE_BUCKET_NAME: string;
		STORAGE_MAX_SIZE_PER_FILE: string;
		PENDING_ORDER_STATUS_UUID: string;
		CANCEL_ORDER_STATUS_UUID: string;
		READY_ORDER_STATUS_UUID: string;
		ON_PROCESS_STATUS_UUID: string;
		COMPLETE_STATUS_UUID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PROD_DB_PORT" | "PROD_DB_SSL" | "PROD_DB_SSL_REJECT_UNAUTHORIZED" | "PROD_DB_SSL_CA" | "PROD_DB_SSL_KEY" | "PROD_DB_SSL_CERT" | "PROD_DB_STATEMENT_TIMEOUT" | "PROD_DB_QUERY_TIMEOUT" | "PROD_DB_CONNECTION_TIMEOUT" | "PROD_DB_POOL_MIN" | "PROD_DB_POOL_MAX" | "NODE_ENV" | "PORT" | "LOG_LEVEL" | "LOG_FORMAT" | "CORS_ORIGINS_ALLOW" | "DB_DEBUG" | "BCRYPT_SALT_ROUNDS" | "JWT_SECRET" | "JWT_EXPIRES_IN" | "DEV_DB_HOST" | "DEV_DB_PORT" | "DEV_DB_NAME" | "DEV_DB_USER" | "DEV_DB_PASSWORD" | "DEV_DB_SSL" | "DEV_DB_SSL_REJECT_UNAUTHORIZED" | "STORAGE_URL" | "STORAGE_SECRET_KEYS" | "STORAGE_BUCKET_NAME" | "STORAGE_MAX_SIZE_PER_FILE" | "PENDING_ORDER_STATUS_UUID" | "CANCEL_ORDER_STATUS_UUID" | "READY_ORDER_STATUS_UUID" | "ON_PROCESS_STATUS_UUID" | "COMPLETE_STATUS_UUID" | "CLIENT_SECRET_KEY" | "SERVER_SECRET_KEY" | "MERCHANT_ID">> {}
}
